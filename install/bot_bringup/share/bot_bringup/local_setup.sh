...
: ${AMENT_CURRENT_PREFIX:="/home/kraiwich/Lab1_ws/install/bot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bot_bringup/environment/pythonpath.sh"
